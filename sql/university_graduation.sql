...
CREATE TABLE `graduation` (
  `graduation_num` int(11) NOT NULL,
  `graduation_requirment_num` int(11) DEFAULT NULL,
  ...
  KEY `graduation_requirment_num_idx` (`graduation_requirment_num`),
  CONSTRAINT `graduation_requirment_num` FOREIGN KEY (`graduation_requirment_num`) REFERENCES `requirment` (`requirment_num`)

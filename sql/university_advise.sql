...
CREATE TABLE `advise` (
  ...
  KEY `adivs_student_num_idx` (`advise_student_num`),
  CONSTRAINT `adivs_student_num` FOREIGN KEY (`advise_student_num`) REFERENCES `student` (`student_num`),
...
INSERT INTO `advise` VALUES (1,2001134997,2019135133),(2,2001134998,2019135134),(3,2001134999,2019135135),(4,2001135000,2019135136),(5,2001135001,2019135137);
